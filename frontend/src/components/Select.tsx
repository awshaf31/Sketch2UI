...
// Select. Deliberately a styled shell around the native <select> (not a custom listbox) —
// every current use case (class picker, display mode, parent dropdown) is a short flat
// option list, and native selects give correct keyboard/screen-reader behavior for free.
