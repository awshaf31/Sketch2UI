...
// Section Header. Formalizes the uppercase small-caps label pattern already used informally
// today (InspectorPanel.tsx's `h3` className string, repeated six times) into one
// component.
