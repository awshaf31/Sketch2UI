...
```bash
/usr/bin/python3 -m venv services/cv-worker/.venv        # Python 3.9
services/cv-worker/.venv/bin/pip install -r services/cv-worker/requirements.txt
```
