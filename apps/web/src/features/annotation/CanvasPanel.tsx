...
export function CanvasPanel({
  ...
  // "Fit-to-screen"). Runs once per asset id, not on every resize — a later window
  // resize doesn't silently change the user's chosen zoom (explicit action, not
  // ambient behavior, matching design-direction.md's interaction style).
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="relative flex-1 overflow-hidden">
        <div ref={scrollRef} onWheel={handleWheel} className="h-full overflow-auto bg-surface-sunken p-lg">
