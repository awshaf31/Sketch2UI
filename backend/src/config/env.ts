...
// Repo root is backend/src/config -> ../../..
...
export const env = {
  ...
  storeFile: process.env.STORE_FILE ?? path.join(REPO_ROOT, "backend", "data", "store.json"),
  ...
  // cv-service. Loopback by default — plan section 19.6: the worker must not be
