 ...
 *
 * Verified safe before making this change: `frontend` never reads an override map off
...
export interface UserRepository {
  ...
  /** The one supported role mutation (backend/scripts/promote-admin.ts) — a
   ...
   * backend/src, including test files. */
